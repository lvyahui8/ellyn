...
Download the demo program for your platform from[GitHub Releases](https://github.com/lvyahui8/ellyn/releases), run it, and open<http://localhost:19898>.

![Call chain visualization](./.assets/graph.png)

## CLI Usage

Download the`ellyn`CLI from[GitHub Releases](https://github.com/lvyahui8/ellyn/releases).
...
-   [int64 GUID Generator](./sdk/common/guid/guid.go): Generates call IDs.
